...
function serveDropToggle() {
  if (window.innerWidth < "1024") {
    if (serviceList.classList.contains("shown")) {
      ...
      gsap.to(serviceList, {duration: 0.2, height: "0", ease: "power1.inOut"});
    } else {
      ...
      gsap.to(serviceList, {duration: 0.2, height: "auto", ease: "power1.inOut"});
      gsap.to(processList, { duration: 0.2, height: "0", ease: "power1.inOut" });
    };
  };
};
...
function processDropToggle() {
  if (window.innerWidth < "1024") {
    if (processList.classList.contains("shown")) {
      ...
      gsap.to(servRight, { duration: 0.2, x: 0, ease: "power1.inOut" });
      gsap.to(servLeft, { duration: 0.2, x: 0, ease: "power1.inOut" });
      gsap.to(processList, {duration: 0.2, height: "auto", ease: "power1.inOut",});
      gsap.to(serviceList, { duration: 0.2, height: "0", ease: "power1.inOut" });
    };
  };
};
...
function serveSubShow() {
  if (window.innerWidth >= "1024") {
    ...
    gsap.to(servicesList, {duration:.3, opacity:1});
  };
};
...
function screenAdjust() {
  ...
  if (window.innerWidth >= "1024") {
    ...
    serviceList.classList.remove("shown");
    processList.classList.remove("shown");
    gsap.to(hamTop, {duration: 0.01, transformOrigin: "50% 50%", rotation: 0, scaleX: 1, y: 0 });
    gsap.to(hamBottom, {duration: 0.01, transformOrigin: "50% 50%", rotation: 0, scaleX: 1, y: 0});
